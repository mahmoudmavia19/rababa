...
class UpdateTeacherProfileScreen extends StatefulWidget {
  const UpdateTeacherProfileScreen({Key? key}) : super(key: key);
...
class _UpdateTeacherProfileScreenState extends State<UpdateTeacherProfileScreen> {
  ...
  final TeacherMainProfileViewModel _viewModel =instance();
  @override
  void initState() {
    super.initState();
    _viewModel.start();
      ...
      builder: (context, snapshot) {
        return Column(
          children: [
            ...
            CustomTextField(title: AppStrings.country ,subTitle: _viewModel.user.country,onChanged: (value) {
              _viewModel.setCountry(value) ;
            }, ) ,
